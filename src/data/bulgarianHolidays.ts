...
function getHolidaysForYear(year: number): Holiday[] {
  ...
  holidays.push(
    ...
    { date: `${year}-06-29`, name: 'Петровден – Петър, Петра, Петко, Петкана, Камен, Павел, Павлина, Паулина', type: 'nameday' },

    // Юли
    { date: `${year}-07-01`, name: 'Козма, Дамян, Дамяна', type: 'nameday' },
    { date: `${year}-07-07`, name: 'Св. Неделя – Неделя, Недялко, Недялка', type: 'nameday' },
    ...
    { date: `${year}-08-09`, name: 'Св. ап. Матия – Матей, Матея', type: 'nameday' },
  ...
  holidays.push(
    ...
    { date: `${year}-01-08`, name: 'Бабинден', type: 'folk' },
    { date: `${year}-01-20`, name: 'Св. Евтимий Търновски', type: 'folk' },
    ...
    { date: `${year}-11-11`, name: 'Мратинци - празник на вълците', type: 'folk' },
    ...
    { date: `${year}-12-04`, name: 'Варваринден - закрилница на децата', type: 'folk' },
    ...
    { date: `${year}-12-27`, name: 'Стефановден - народни обичаи', type: 'folk' },
